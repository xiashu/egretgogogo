...
function crateCode(param){

  wing.webview.ipc.sendToExtensionHost('ping', 'MSG_CREATE',param); 
 
}


function inserCode(param){

  wing.webview.ipc.sendToExtensionHost('ping', 'MSG_INSERTER',param); 
